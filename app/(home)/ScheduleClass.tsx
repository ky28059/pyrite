    ...
    return (
        <>
            <button
                ...
                className="z-10 bg-theme text-left text-white rounded px-4 py-3 hover:ring-4 hover:ring-yellow-500/30 transition duration-100 focus:outline-none focus-visible:ring-[3px]"
