...
export default function DayAlert(props: DayAlertProps) {
    ...
    return (
        <Transition
            ...
            leaveTo="opacity-0"
        >
            <div className="absolute z-50 left-3 right-3 top-10 sm:top-14 flex gap-2 items-center max-w-6xl mx-auto shadow-lg border-none bg-content-secondary rounded px-5 py-3 pr-16">
                {makeDateString()}
